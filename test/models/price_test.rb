...
class PriceTest < ActiveSupport::TestCase
  def setup
    ...
    @price = Price.new(price: 20000,
                       date_from: '2022-01-01',
                       date_until: '2122-01-01',
                       product_id: @product.id)
    
                       #  scope testing https://dev.to/konnorrogers/testing-scopes-with-rails-4ho9
    @price_1 = Price.create!(price: 20000, date_from: '2022-01-01', date_until: '2122-12-31', product_id: @product.id)
    @price_1a = Price.create!(price: 21000, date_from: '2022-06-01', date_until: '2022-12-31', product_id: @product.id)
    @price_2 = Price.create!(price: 22000, date_from: '2023-01-01', date_until: '2023-12-31', product_id: @product.id)
    @price_3 = Price.create!(price: 25000, date_from: '2024-01-01', date_until: '2124-12-31', product_id: @product.id)
