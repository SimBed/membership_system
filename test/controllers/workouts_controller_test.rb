...
class WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post workouts_url, params: { workout: { instructor_id: @workout.instructor_id, name: @workout.name } }
    end
  ...
  test "should update workout" do
    patch workout_url(@workout), params: { workout: { instructor_id: @workout.instructor_id, name: @workout.name } }
