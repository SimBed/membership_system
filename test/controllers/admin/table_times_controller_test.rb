...
class Admin::TableTimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should show table_time" do
    log_in_as(@admin)
    get admin_table_time_url(@table_time)
    assert_response :success
  end
  ...
  test "should update table_time" do
    ...
    assert_redirected_to admin_table_time_url(@table_time)
  end
  ...
  test "should destroy table_time" do
    ...
    assert_redirected_to admin_table_times_url
  end
end
