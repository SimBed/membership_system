...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { first_name: @partner.first_name, last_name: @partner.last_name } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { first_name: @partner.first_name, last_name: @partner.last_name } }
