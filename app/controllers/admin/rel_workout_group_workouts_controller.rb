class Admin::RelWorkoutGroupWorkoutsController < Admin::BaseController
  ...
  def create
    @rel_workout_group_workout = RelWorkoutGroupWorkout.new(rel_workout_group_workout_params)
      ...
      if @rel_workout_group_workout.save
        redirect_to admin_rel_workout_group_workout_path(@rel_workout_group_workout)
  ...
  def destroy
    ...
    redirect_to admin_rel_workout_group_workouts_path
