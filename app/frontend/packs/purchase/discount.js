...
$(function() {
  $("select#purchase_commercial_discount_id").on("change", function() {
    ajax_call_to_purchases_discount_when_discount_or_product_changes()
  });
});

$(function() {
  $("select#purchase_discretion_discount_id").on("change", function() {
    ajax_call_to_purchases_discount_when_discount_or_product_changes()
  });
});
...
function ajax_call_to_purchases_discount_when_discount_or_product_changes() {
  $.ajax({
    ...
    data: { selected_renewal_discount_id: document.getElementById("purchase_renewal_discount_id").value || 0,
            ...
            selected_commercial_discount_id: document.getElementById("purchase_commercial_discount_id").value || 0,
            selected_discretion_discount_id: document.getElementById("purchase_discretion_discount_id").value || 0,
